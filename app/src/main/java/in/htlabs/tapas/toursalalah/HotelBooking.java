 ...
 */
public class HotelBooking extends Activity implements View.OnClickListener {
   EditText hb_et_cin,hb_et_cout,hb_et_room,hb_et_adult,hb_et_child;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hb_et_room=(EditText)findViewById(R.id.hb_et_room);
    ...
    class BookHotel extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HotelBooking.this);
